    ...
    <main className="mx-auto w-full max-w-6xl px-6 pb-24 pt-14">
      <div className="flex flex-col gap-2">
        ...
        <p className="mono text-[12px] text-[#1b1b1b]/55">
          Colloquia, salons, and working sessions. Archive remains visible.
        </p>
      </div>
      ...
      <section className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {list.map((e) => (
          ...
          >
            ...
            {e.blurb ? (
              <div className="mt-3 text-[12px] leading-relaxed text-[#1b1b1b]/60">
                {e.blurb}
              </div>
            ) : (
              <div className="mt-3 text-[12px] leading-relaxed text-[#1b1b1b]/35">
                Details
              </div>
            )}
          </button>
              ...
              <div className="border rule bg-[rgb(var(--ivory))] shadow-paper">
                ...
                <div className="border-t rule px-5 py-5">
                  {selected.description ? (
                    <div className="text-[13px] leading-relaxed text-[#1b1b1b]/70">
                      {selected.description}
                    </div>
                  ) : null}
