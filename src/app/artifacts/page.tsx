  ...
  return (
    <section className="mx-auto max-w-5xl px-6 pt-12 pb-20">
      <div className="space-y-3">
        <div className="smallcaps text-[11px] text-[#6a6258]">Research</div>
        <h1 className="md-display text-[54px] leading-[1.02] tracking-[-0.02em] text-[#191714]">Artifacts</h1>
        <p className="max-w-[62ch] text-[14px] leading-relaxed text-[#4b443b]">
        ...
        {artifacts.map((a) => {
          ...
          return (
            <Link
              ...
              className="paper shadow-paper border rule rounded-2xl p-7 block hover:translate-y-[-1px] transition"
            >
              <div className="flex items-center justify-between gap-6">
                ...
                <div className="smallcaps text-[10px] text-[#6a6258]">{year}</div>
              </div>

              <h2 className="mt-3 md-display text-[22px] leading-[1.18] tracking-[-0.01em] text-[#191714]">
                {a.title}
              </h2>

              <p className="mt-3 max-w-[95ch] text-[13px] leading-relaxed text-[#4b443b]">
                {teaser(a.abstract ?? "")}
              </p>
